class PaginaInicio {
    ...
    negociosSocios.forEach(negocio => {
      ...
      article.innerHTML = `
        <div class="imagen-contenedor">
            <img src="${urlImagen}" alt="${nombre}" loading="lazy" class="img-negocio" onerror="this.src='assets/tiendas_default.png'">
  ...
  async inizializar() { await this.cargarconfigs(); await this.cargarNegocios(); }
}
